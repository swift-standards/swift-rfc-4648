...
struct DataEncodingTests {
    ...
    func testDataBase64URLSafeCharacters() {
    ...
    func testDataBase32CaseInsensitive() {
    ...
    func testDataBase32HexEncoding() {
        let data = Data("foo".utf8)
    ...
    func testDataBase32HexDecoding() {
        let encoded = "CPNMU==="
    ...
    func testDataBase32HexDifference() {
        let data = Data("foo".utf8)
    ...
    @Test("Data hexadecimal round-trip", arguments: [
        Data([0x00]),
        Data([0xFF]),
        Data([0x00, 0x0F, 0xFF]),
    ...
    func testDataHexRoundTrip(input: Data) {
    ...
    @Test("Empty data encoding", arguments: [
        "base64URL", "base32", "base32Hex", "hex"
    ])
    func testEmptyDataEncoding(encoding: String) {
        let empty = Data()
    ...
    @Test("Empty string decoding", arguments: [
        "base64URL", "base32", "base32Hex", "hex"
    ])
    func testEmptyStringDecoding(encoding: String) {
        let empty = ""
